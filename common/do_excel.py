...
class Cases:
    def __init__(self):
        ...
        self.json=None
        self.expect=None
        self.check_exist=None
        self.check_noexist=None
        self.prename=None
        self.event=None
...
class Doexcel:
    ...
    def read_excel(self):
        ...
        for row in range(2,self.sheet.max_row+1):
            ...
            cases.check_exist = self.sheet.cell(row,12).value
            cases.check_noexist = self.sheet.cell(row,13).value
            cases.prename = self.sheet.cell(row,14).value
            cases.event = self.sheet.cell(row,15).value
            case.append(cases)
        return case
